...
export const App = () => {
    ...
    const [oneStopCheckbox, setOneStopCheckbox] = useState(false)
    const [twoStopsCheckbox, setTwoStopsCheckbox] = useState(false)
    const [threeStopsCheckbox, setThreeStopsCheckbox] = useState(false)
    const [withoutStopsCheckbox, setWithoutStopsCheckbox] = useState(false)
    ...
    const chooseOnlyMe = useCallback((value) => {
